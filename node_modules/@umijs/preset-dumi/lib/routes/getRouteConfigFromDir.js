...
function findChildRoutes(absPath, opts, parentRoutePath = '/') {
  var _ctx$umi, _opts$resolve, _opts$resolve$example, _opts$resolve2;
  ...
  if ((_opts$resolve2 = opts.resolve) === null || _opts$resolve2 === void 0 ? void 0 : _opts$resolve2.excludes) {
